...
<head>
    ...
    <title>Hotel Booking Maintance | Dashboard</title>
    ...
    <!-- Ionicons -->
    <link rel="stylesheet" href='amin/bower_components/Ionicons/css/ionicons.min.css'>
    <!-- Theme style -->
...
<script src='angular/js/ocLazyLoad.min.js'></script>
<script src='angular/js/angular-ui-router.js'></script>
<script src='angular/js/main.js' type="text/javascript"></script>
<script src='angular/js/routes.js' type="text/javascript"></script>
